...
# insight_terminus documentation build
...
from insight_terminus import __version__ as release

# -- Project information -----------------------------------------------------

project = "insight_terminus"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "insight_terminusdoc"
...
latex_documents = [
    (
        master_doc,
        "insight_terminus.tex",
        "insight_terminus Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "insight_terminus",
        "Project insight_terminus codebase.",
        "Data-Science",
    )
]
